...
export function RegisterScreen() {
  ...
  const canSubmit =
    name.trim().length > 1 && email.trim().length > 3 && password.length >= 6 && !submitting;

  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-6 py-16">
      <div className="w-full max-w-md">
        <div className="text-center">
          <div className="text-2xl font-semibold tracking-tight text-gray-900">Register</div>
        ...
        <Card className="mt-8 rounded-xl border-gray-200/50 p-6">
          ...
          <div className="mt-5 text-center text-sm text-gray-600">
            ...
            <Link href="/ui/auth/login" className="font-medium text-gray-900 hover:opacity-70">
              Login
            </Link>
          </div>
        </Card>
