    ...
    <>
      ...
      >
        <div>
          ...
          <div className={styles.sectionTitle}>Detail balance</div>
          <div className={styles.sectionSubtitle}>
            Refines the smaller signals including eye spacing, nasal proportion, and
            lip symmetry.
          </div>
        </div>
      ...
      >
        <div className={styles.statCard}>
          <div className={styles.statLabel}>Features Score</div>
          <div className={`${styles.statValue} ${locked ? styles.blur : ""}`}>
            {formatScore(face.featuresScore)} / 10
          </div>
        </div>
        <div className={styles.statCard}>
      ...
      <div className={styles.heroGrid}>
        ...
        >
          <div className={styles.statLabel}>Features Insight</div>
          <div className={styles.sectionSubtitle}>
            Micro-features influence perceived refinement. Consistent spacing and
            proportion typically raise this pillar.
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 12 }}
        ...
        >
          <DistributionChart locked={locked} score={face.featuresScore} />
        </motion.div>
      </div>
      ...
      >
        <AssessmentPanel
          title="Features Assessments"
          subtitle="Signals around spacing, proportion, and symmetry." 
          items={face.featuresAssessments}
          locked={locked}
        />
      </motion.div>
    </>
