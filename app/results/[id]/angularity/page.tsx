...
export default function AngularityPage() {
  ...
  return (
    <>
      ...
      >
        <div>
          <div className={styles.sectionEyebrow}>Angularity</div>
          <div className={styles.sectionTitle}>Definition and structure</div>
          <div className={styles.sectionSubtitle}>
            Evaluates jawline, cheek contour, and overall structural sharpness.
          </div>
        </div>
      ...
      >
        <div className={styles.statCard}>
          <div className={styles.statLabel}>Angularity Score</div>
          <div className={`${styles.statValue} ${locked ? styles.blur : ""}`}>
            {formatScore(face.angularityScore)} / 10
          </div>
        </div>
        <div className={styles.statCard}>
          <div className={styles.statLabel}>Score Percentile</div>
          <div className={`${styles.statValue} ${locked ? styles.blur : ""}`}>
            {face.angularityScore}%
          </div>
        </div>
      </motion.div>
      ...
      <div className={styles.heroGrid}>
        ...
        >
          <div className={styles.statLabel}>Angularity Insight</div>
          <div className={styles.sectionSubtitle}>
            Higher angularity indicates stronger edges along the jaw and cheek line,
            often associated with a sharper silhouette.
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 12 }}
        ...
        >
          <DistributionChart locked={locked} score={face.angularityScore} />
        </motion.div>
      </div>
      ...
      >
        <AssessmentPanel
          title="Angularity Assessments"
          subtitle="Key structural signals inferred from facial landmarks."
          items={face.angularityAssessments}
          locked={locked}
        />
      </motion.div>
    </>
